...
@Data
@Schema(description = "Request DTO for creating a new purchase")
public class CreatePurchaseRequest {

    @NotNull(message = "Pump Master ID is required")
    @Schema(description = "Pump Master ID this purchase belongs to", example = "123e4567-e89b-12d3-a456-426614174000", required = true)
