...
@Data
@Schema(description = "Request DTO for creating a new customer bill payment")
public class CreateCustomerBillPaymentRequest {
    ...
    @Schema(description = "Bank Account ID where payment is deposited", example = "123e4567-e89b-12d3-a456-426614174000", required = true)
