...
@Data
@Schema(description = "Request DTO for updating an existing tank")
public class UpdateTankRequest {
    ...
    @Schema(description = "Opening level in litres", example = "1000.00")
    private BigDecimal openingLevel;

    @Schema(description = "Opening level date", example = "2025-01-01")
    ...
    @Schema(description = "Product ID this tank stores", example = "123e4567-e89b-12d3-a456-426614174000")
