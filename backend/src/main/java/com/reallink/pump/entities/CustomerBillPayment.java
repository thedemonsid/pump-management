...
public class CustomerBillPayment extends BaseEntity {
    ...
    @JoinColumn(name = "pump_master_id", nullable = false, foreignKey = @ForeignKey(name = "fk_customer_bill_payment_pump_master"))
    private PumpInfoMaster pumpMaster;

    @ManyToOne(fetch = FetchType.LAZY, optional = true)
    @JoinColumn(name = "bill_id", nullable = true, foreignKey = @ForeignKey(name = "fk_customer_bill_payment_bill"))
    private Bill bill;

    @NotNull(message = "Customer is required")
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "customer_id", nullable = false, foreignKey = @ForeignKey(name = "fk_customer_bill_payment_customer"))
    private Customer customer;

    @NotNull(message = "Bank account is required")
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "bank_account_id", nullable = false, foreignKey = @ForeignKey(name = "fk_customer_bill_payment_bank_account"))
    ...
    @JoinColumn(name = "bank_transaction_id", nullable = false, foreignKey = @ForeignKey(name = "fk_customer_bill_payment_bank_transaction"))
