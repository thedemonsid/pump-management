...
public interface ShiftMasterMapper {
    ...
    /**
     * Maps CreateShiftRequest to ShiftMaster entity
     */
    @Mapping(target = "active", constant = "true")
    @Mapping(target = "pumpMaster.id", source = "pumpMasterId")
    ShiftMaster toEntity(CreateShiftRequest request);

    /**
     * Maps ShiftMaster entity to ShiftResponse
     */
    ...
    ShiftResponse toResponse(ShiftMaster entity);

    /**
     * Maps list of ShiftMaster entities to list of ShiftResponse
     */
    List<ShiftResponse> toResponseList(List<ShiftMaster> entities);

    /**
     * Updates existing ShiftMaster entity with UpdateShiftRequest data Only
    ...
    void updateEntity(UpdateShiftRequest request, @MappingTarget ShiftMaster entity);
    ...
    @Mapping(target = "updatedAt", ignore = true)
    @Mapping(target = "version", ignore = true)
    void partialUpdate(CreateShiftRequest request, @MappingTarget ShiftMaster entity);
