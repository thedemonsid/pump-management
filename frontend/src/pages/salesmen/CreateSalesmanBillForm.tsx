...
type CreateSalesmanBillFormData = CreateBillRequest;

interface CreateSalesmanBillFormProps {
  onSuccess: () => void;
}

export function CreateSalesmanBillForm({
  onSuccess,
}: CreateSalesmanBillFormProps) {
  ...
  const form = useForm<CreateSalesmanBillFormData>({
    ...
    defaultValues: {
      ...
      customerId: '',
      billType: 'SALESMAN', // Fixed to SALESMAN
  ...
  const onSubmit = async (data: CreateSalesmanBillFormData) => {
