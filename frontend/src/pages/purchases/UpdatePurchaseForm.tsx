...
export function UpdatePurchaseForm({
  purchase,
  onSuccess,
}: UpdatePurchaseFormProps) {
  const { editPurchase, loading } = usePurchaseStore();
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      rateType: purchase.rateType,
      paymentType: purchase.paymentType,
      supplierId: purchase.supplierId,
      invoiceNumber: purchase.invoiceNumber,
      addToStock: purchase.addToStock,
      productId: purchase.productId,
      quantity: purchase.quantity,
      purchaseRate: purchase.purchaseRate,
      amount: purchase.amount,
      goodsReceivedBy: purchase.goodsReceivedBy || '',
  ...
  const onSubmit = async (data: UpdatePurchase) => {
    setIsSubmitting(true);
    try {
      await editPurchase(purchase.id!, data);
      onSuccess();
    } catch (error) {
